...
import { validateBuilding, validateComplex, validateHeatingSystem, validateStandings, validateVentilationSystem, type StandingsErrors } from "../model/Validation.model";
