...
export default function LightingSystem() {
  ...
  const [formErrors, setFormErrors] = useState<Array<LightingErrors | string> | null>(null);
  const [activeLightingIndex, setActiveLightingIndex] = useState<number | null>(
    null,
  );
  ...
  async function handleSubmit(){
    const result = await FormSendProtocol.handleLightingSystem(formData, setLoading, setFormErrors);
    ...
    >
      ...
      {currentActiveLighting && (
        ...
        mt: 3,
          ...
          <FormControl error={formErrors !== null && activeLightingIndex !== null && formErrors[activeLightingIndex] !== "none"}>
            <TextField
              variant="standard"
              label="Zóna megnevezése"
              value={formData[activeLightingIndex!].zone}
              onChange={(e) =>
                handleActiveLightingSystemChange("zone", e.target.value)
              }
            />
            {formErrors !== null && activeLightingIndex !== null && formErrors[activeLightingIndex] !== "none" && (formErrors[activeLightingIndex] as LightingErrors).zone && <FormHelperText>{(formErrors[activeLightingIndex] as LightingErrors).zone}</FormHelperText>}
          </FormControl>
          <FormControl error={formErrors !== null && activeLightingIndex !== null && formErrors[activeLightingIndex] !== "none"}>
            <TextField
              variant="standard"
              ...
              onChange={(e) =>
                handleActiveLightingSystemChange("size", e.target.value)
              }
            />
            {formErrors !== null && activeLightingIndex !== null && formErrors[activeLightingIndex] !== "none" && (formErrors[activeLightingIndex] as LightingErrors).size && <FormHelperText>{(formErrors[activeLightingIndex] as LightingErrors).size}</FormHelperText>}
          </FormControl>
          <FormControl>
            <InputLabel id="solution-select">Világítás megoldása</InputLabel>
            <Select
              label="Megoldás"
              labelId="solution-select"
              value={formData[activeLightingIndex!].solution}
              onChange={(e) =>
                handleActiveLightingSystemChange("solution", e.target.value)
              }
            >
              {LightingSolutions.map((e: string, index: number) => (
          ...
          <FormControl>
            <InputLabel id="dim-select">Fényerő szabályozhatóság</InputLabel>
            <Select
              label="Szabályozhatóság"
              labelId="dim-select"
              value={formData[activeLightingIndex!].dim}
              onChange={(e) =>
                handleActiveLightingSystemChange("dim", e.target.value)
              }
            >
          ...
          <FormControl>
            <InputLabel id="zone-usage-select">Zóna rendeltetése</InputLabel>
            <Select
              label="Rendeltetés"
              labelId="zone-usage-select"
              value={formData[activeLightingIndex!].zoneUsage}
              onChange={(e) =>
                handleActiveLightingSystemChange("zoneUsage", e.target.value)
              }
            >
          ...
          <FormControl>
            <InputLabel id="regulation-select">Szabályozás típusa</InputLabel>
            <Select
              label="Szabályozás"
              labelId="regulation-select"
              value={formData[activeLightingIndex!].regulation}
              onChange={(e) =>
                handleActiveLightingSystemChange("regulation", e.target.value)
              }
            >
              {LightingRegulation.map((e: string, index: number) => (
                <MenuItem key={index} value={e}>
                  {e}
                </MenuItem>
              ))}
          ...
          <FormControl>
            ...
            <Select
              ...
              onChange={(e) =>
                handleActiveLightingSystemChange("naturalLight", e.target.value)
              }
            >
              {LightingNaturalLightRatio.map((e: string, index: number) => (
                <MenuItem key={index} value={e}>
                  {e}
                </MenuItem>
              ))}
          ...
          <FormControl>
            <InputLabel id="emergency-select">Vészvilágítás</InputLabel>
            <Select
              label="Vészvilágítás van/nincs"
              labelId="emergency-select"
              value={formData[activeLightingIndex!].emergency ? 1 : 0}
              onChange={(e) =>
          ...
          <FormControl>
            ...
            <Select
              ...
              value={formData[activeLightingIndex!].standBy ? 1 : 0}
              onChange={(e) =>
                handleActiveLightingSystemChange(
                  "standBy",
                  Boolean(e.target.value),
