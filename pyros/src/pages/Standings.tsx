...
export default function Standings() {
    ...
    return (
        ...
        >
            ...
            <FormControl fullWidth>
                <InputLabel id="measurement-type-select">
                    Mérés típusa
                </InputLabel>
                <Select
                    ...
                    {Object.keys(MeasurementTypes).map((e: string) => {
                        return (
                            <MenuItem value={e}>
                                {
                                    MeasurementTypes[
                                        e as keyof typeof MeasurementTypes
                                    ]
                                }
                            </MenuItem>
                        )
            ...
            {formData.measurementType !== ('MAIN' as MeasurementTypes.MAIN) ? (
                <FormControl>
                    ...
                    >
                        {mainMeasurements.map((measurement: StandingsShort) => {
                            return (
                                <MenuItem value={measurement.id!}>
                                    {measurement.name}
                                </MenuItem>
                            )
                        })}
                    ...
                    {Object.keys(EnergyMeasurements).map((e: string) => {
                        return (
                            <MenuItem value={e}>
                                {
                                    EnergyMeasurements[
                                        e as keyof typeof EnergyMeasurements
                                    ]
                                }
                            </MenuItem>
                        )
