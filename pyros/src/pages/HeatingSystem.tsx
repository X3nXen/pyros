...
export default function HeatingSystem() {
  ...
  function handleAddEmitter(){
    ...
    setFormData({...formData, emitters: [...formData.emitters, newEmitter]});
  ...
  function handleActivePumpChange(field: keyof PumpFormData, value: string | number | string[] | boolean | null | ServicedBuildingShort[]){
  ...
  function handleActiveEmitterChange(
    ...
    value: string | number | string[] | boolean | null | ServicedBuildingShort[]
  ){
  ...
  const currentActiveEmitter =
    activeEmitterIndex !== null ? formData.emitters[activeEmitterIndex] : null;
  ...
  return (
    ...
    >
      ...
      <FormControl variant="standard" fullWidth>
        <InputLabel id="system-purpose-selector">Rendszer működése</InputLabel>
        <Select
      ...
      <FormControl variant="standard" fullWidth>
        ...
        <Select
          ...
          onChange={(e) =>
            setFormData({
              ...formData,
              systemRegulation: e.target.value as SystemRegulation,
            })
          }
        >
      ...
      <FormControl variant="standard" fullWidth>
        ...
        <Select
          ...
          onChange={(e) =>
            setFormData({
              ...formData,
              systemRegulationDesc: e.target.value as SystemRegulationDesc,
            })
          }
        >
