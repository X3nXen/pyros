...
export default function VentilationSystem() {
  ...
  function handleChange(field: keyof VentilationFormData, value: string | number | [] | null | ServicedBuildingShort[]) {
  ...
  return (
    ...
    >
      <h1>Légkezelő rendszer rögzítése</h1>
      ...
      <FormControl error={!!formErrors?.servicedBuilding}>
        ...
        {formErrors?.servicedBuilding && (
          <FormHelperText>{formErrors.servicedBuilding}</FormHelperText>
        )}
      </FormControl>
      {formData.servicedBuilding.map((e: ServicedBuildingShort) => {
        return (
          <FormControl error={!!(formErrors?.servicedSizes && formErrors?.servicedSizes[e.buildingId])}>
            <TextField
              ...
              onChange={(event) => {
                ...
                handleChange("servicedBuilding", formData.servicedBuilding);
              }}
            />
            {formErrors?.servicedSizes && formErrors?.servicedSizes[e.buildingId] && (
              <FormHelperText>
      ...
      {formData.type === VentilationBase.WATER ? (
        <Box>
          <FormControl error={!!formErrors?.forwardHeat}>
            <TextField
              ...
              onChange={(e) => handleChange("forwardHeat", e.target.value)}
            />
            {formErrors?.forwardHeat && <FormHelperText>{formErrors.forwardHeat}</FormHelperText>}
          </FormControl>
          <FormControl error={!!formErrors?.backHeat}>
            ...
            />
            {formErrors?.backHeat && <FormHelperText>{formErrors.backHeat}</FormHelperText>}
          </FormControl>
        </Box>
      ) : (
        <></>
      ...
      <FormControl>
        <InputLabel id="fan-select">Ventilátor működési módja</InputLabel>
        <Select
          label="Működési mód"
          labelId="fan-select"
          value={formData.ventilatorType}
          onChange={(e) => handleChange("ventilatorType", e.target.value)}
        >
      ...
      {formData.ventilatorType === VentilationTypes.OTHER ? (
        <FormControl error={!!formErrors?.ventilationOther}>
          <TextField
            ...
            onChange={(e) => handleChange("ventilationOther", e.target.value)}
          />
          {formErrors?.ventilationOther && <FormHelperText>{formErrors.ventilationOther}</FormHelperText>}
        </FormControl>
      ) : (
        <></>
      )}
      <FormControl error={!!formErrors?.suckRatio}>
        ...
        />
        {formErrors?.suckRatio && <FormHelperText>{formErrors.suckRatio}</FormHelperText>}
      </FormControl>
      <FormControl error={!!formErrors?.suckPower}>
        ...
        />
        {formErrors?.suckPower && <FormHelperText>{formErrors.suckPower}</FormHelperText>}
      </FormControl>
      <FormControl error={!!formErrors?.blowRatio}>
        ...
        />
        {formErrors?.blowRatio && <FormHelperText>{formErrors.blowRatio}</FormHelperText>}
      </FormControl>
      <FormControl error={!!formErrors?.blowPower}>
        ...
        />
        {formErrors?.blowPower && <FormHelperText>{formErrors.blowPower}</FormHelperText>}
      </FormControl>
      <FormControl>
        <InputLabel id="retriever-select">Hővisszanyerő típusa</InputLabel>
        <Select
          label="Hővisszanyerő típusa"
      ...
      {formData.retriever !== VentilationHeatRetrievers.NONE ? (
        <FormControl error={!!formErrors?.retrieverYear}>
          <TextField
            ...
            onChange={(e) => handleChange("retrieverYear", e.target.value)}
          />
          {formErrors?.retrieverYear && <FormHelperText>{formErrors.retrieverYear}</FormHelperText>}
        </FormControl>
      ) : (
        <></>
      )}
      ...
      {formData.insulationMaterial === VentilationInsulationMaterial.NONE ? (
        <></>
      ) : (
        <FormControl error={!!formErrors?.insulationWidth}>
          <TextField
            ...
            onChange={(e) => handleChange("insulationWidth", e.target.value)}
          />
          {formErrors?.insulationWidth && <FormHelperText>{formErrors.insulationWidth}</FormHelperText>}
        </FormControl>
      )}
      <FormControl>
        <InputLabel id="regulation-select">Légkezelő szabályozása</InputLabel>
        <Select
          label="Szabályozás"
